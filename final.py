...
def channels_table(channelnames):
    ...
    for index,row in df_singlechannelinfo.iterrows():#to check the function of iterrows use print(index,row)
...
def playlist_table(channelnames):
        ...
        for index,row in df_singleplaylistinfo.iterrows():#to check the function of iterrows use print(index,row)
...
def comment_table(channelnames):
        ...
        for index,row in df_singlecommentinfo.iterrows():#to check the function of iterrows use print(index,row)
